...
# packages = ["bitsandbytes==0.37.2", "accelerate", "appdirs", "loralib", "black", "black[jupyter]", "datasets", "fire",
#             "git+https://github.com/huggingface/peft.git@e536616888d51b453ed354a6f1e243fecb02ea08",
#             "git+https://github.com/huggingface/transformers.git", "sentencepiece", "gradio", "wandb"]
...
from transformers import GenerationConfig, LlamaForCausalLM, LlamaTokenizer, BitsAndBytesConfig, TrainerCallback, \
...
ner_instances = '''
[{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
"input": "-DOCSTART-", 
"output": "None"
},{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
"input": "EU rejects German call to boycott British lamb .", 
"output": "EU, German, British"
},{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
"input": "Peter Blackburn", 
"output": "Peter Blackburn"
},{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
...
"output": "European Commission, German, British"
},{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
...
"output": "EU, Franz Fischler"
},{
"instruction": "Please identify all entities from the input text. If there is no entity, please output None.\n", 
"input": "Fischler proposed EU-wide measures after reports from Britain and France that under laboratory conditions sheep could contract Bovine Spongiform Encephalopathy ( BSE ) -- mad cow disease .", 
"output": "Fischler, EU-wide, Britain, France, Bovine Spongiform Encephalopathy, BSE"}]
'''


json_string = ner_instances.replace('\n', '').replace('\'', '\"')
...
def train(
    ...
    # print(gen_dataset)
    generate_text_callback = GenerateTextCallback(model=model, tokenizer=tokenizer, device=device,
                                                  gen_dataset=gen_dataset, max_length=cutoff_len)
...
def main(
        ...
        lora_weights: str = "model/ner_conll03_no_demo_lr3e-4_r16_alpha16_toi_aet_0",  # "chainyo/alpaca-lora-7b",
